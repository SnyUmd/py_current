...
#------------ステージ0-------------ファイル読込み部
Lbl_tk = WC.SetLabel(       cmm.LBL_File_Sts[3], 
                            cmm.LBL_File_Sts[4], 
                            cmm.LBL_File_Sts[5])

Txb_File_tk = WC.SetTxbEntry(    cmm.TXB_FilePath_Sts[1], 
                            cmm.TXB_FilePath_Sts[2],
                            cmm.TXB_FilePath_Sts[3], 
                            cmm.TXB_FilePath_Sts[4], 
                            cmm.TXB_FilePath_Sts[6], 
                            cmm.TXB_FilePath_Sts[5])

Btn_tk = WC.SetBtn(         cmm.Btn_FileRead_Sts[1], 
                            cmm.Btn_FileRead_Sts[2], 
                            cmm.Btn_FileRead_Sts[3],
                            cmm.Btn_FileRead_Sts[4], 
                            click_file_read,  
                            cmm.Btn_FileRead_Sts[5])

#------------ステージ1-------------ファイルインフォメーション部
Frm_Info_tk = WC.SetFream(      cmm.Frm_Info_tk[1], 
                                cmm.Frm_Info_tk[2], 
                                cmm.Frm_Info_tk[3], 
                                cmm.Frm_Info_tk[4])

Lbl_Title_tk = WC.SetLabel(     cmm.Lbl_Title_tk[3],
                                cmm.Lbl_Title_tk[4],
                                cmm.Lbl_Title_tk[5])

Txb_Title_tk = WC.SetTxbEntry(  cmm.Txb_Title_tk[1], 
                                cmm.Txb_Title_tk[2],
                                cmm.Txb_Title_tk[3], 
                                cmm.Txb_Title_tk[4], 
                                cmm.Txb_Title_tk[6], 
...
Lbl_FileName_tk = WC.SetLabel(      cmm.Lbl_FileName_tk[3],
                                    cmm.Lbl_FileName_tk[4],
                                    cmm.Lbl_FileName_tk[5])

Lbl_FileNameValue_tk = WC.SetLabel( cmm.Lbl_FileNameValue_tk[3],
                                    cmm.Lbl_FileNameValue_tk[4],
                                    cmm.Lbl_FileNameValue_tk[5])
                                
Lbl_FileSize_tk = WC.SetLabel(      cmm.Lbl_FileSize_tk[3],
                                    cmm.Lbl_FileSize_tk[4],
                                    cmm.Lbl_FileSize_tk[5])

Lbl_FileSizeValue_tk = WC.SetLabel( cmm.Lbl_FileSizeValue_tk[3],
                                    cmm.Lbl_FileSizeValue_tk[4],
                                    cmm.Lbl_FileSizeValue_tk[5])

Lbl_FileSize_tk = WC.SetLabel(      cmm.Lbl_Memo_tk[3],
                                    cmm.Lbl_Memo_tk[4],
                                    cmm.Lbl_Memo_tk[5])

Txb_Memo_tk = WC.SetTxbMultiLine(    cmm.Txb_Memo_tk[1], 
                                    cmm.Txb_Memo_tk[2], 
                                    cmm.Txb_Memo_tk[3],
                                    cmm.Txb_Memo_tk[4], 
                                    cmm.Txb_Memo_tk[6], 
...
#------------ステージ2-------------実行ボタン
Btn_tk_BatB_AllCheck = WC.SetBtn(   cmm.Btn_BatB_Sts[1], 
                                    cmm.Btn_BatB_Sts[2], 
                                    cmm.Btn_BatB_Sts[3],
                                    cmm.Btn_BatB_Sts[4], 
                                    click_BadB_AllCheck, 
...
#------------ステージ3-------------ログ部
Txb_Log_tk = WC.SetTxbMultiLine(    cmm.Txb_Log_Sts[1], 
                                    cmm.Txb_Log_Sts[2], 
                                    cmm.Txb_Log_Sts[3],
                                    cmm.Txb_Log_Sts[4], 
                                    cmm.Txb_Log_Sts[6], 
...
Btn_tk_Save_Log_tk = WC.SetBtn(     cmm.Btn_SaveLog[1], 
                                    cmm.Btn_SaveLog[2], 
                                    cmm.Btn_SaveLog[3], 
                                    cmm.Btn_SaveLog[4], 
                                    click_save_log, 
...
#------------デバッグ-------------
# Btn_Debug_tk = WC.SetBtn(           cmm.Btn_Debug_Sts[1], 
#                                     cmm.Btn_Debug_Sts[2], 
#                                     cmm.Btn_Debug_Sts[3],
#                                     cmm.Btn_Debug_Sts[4], 
#                                     click_debug, 
